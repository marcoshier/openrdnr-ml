...
fun main() {
    application {
        ...
        program {
            ...
            val camRt = renderTarget(width, height) {
                colorBuffer()
            }
                        ...
                        layer {
                                draw {
                                    for (rectangle in rectangles) {
                                        ...
                                        contourRt.clearColor(0, ColorRGBa.BLACK)
                                        ...
                                        final.clearColor(0, ColorRGBa.BLACK)
                                            ...
                                            layer {
                                                draw {
                                                    camRt.clearColor(0, ColorRGBa.TRANSPARENT)
                                                    drawer.isolatedWithTarget(camRt) {
                                                        drawer.image(squareImage, squareImage.width*1.0, 0.0, -squareImage.width*1.0, squareImage.height*1.0)
                                                    }
                                                    drawer.image(camRt.colorBuffer(0))
